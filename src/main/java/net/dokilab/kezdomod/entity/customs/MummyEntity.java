...
public class MummyEntity extends Monster {
    ...
    public MummyEntity(EntityType<? extends Monster> pEntityType, Level pLevel) {
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Monster.createMonsterAttributes()
                .add(Attributes.MAX_HEALTH, 14.0)  // 50 hearts like Iron Golem
                .add(Attributes.MOVEMENT_SPEED, 0.17)  // Iron Golem movement speed
                .add(Attributes.ATTACK_DAMAGE, 5.0)  // Average Iron Golem attack damage
                .add(Attributes.ARMOR, 0.0)  // Iron Golems don't have natural armor
                .add(Attributes.FOLLOW_RANGE, 23.0) // Detection range similar to Iron Golem
                .add(Attributes.ATTACK_SPEED, 1.3); // Attacks about once per second
    }
